...
is to create a program that communicates with a server using TCP and UDP protocols. It consists of a compulsory basic part and optional additional parts.
